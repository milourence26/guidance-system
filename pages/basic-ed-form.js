...
import StudentModal from '../components/Basic-ed/BasicEdModal';
import ViewStudentModal from '../components/Basic-ed/ViewStudentModal';
import BasicEdPrintView from '../components/Basic-ed/BasicEdPrintView';
...
export default function PersonalDataTable() {
  ...
  const initialStudentState = {
    ...
    relativesAtHome: [],
    familyIncome: '',
    siblings: Array(4).fill({ name: '', age: '', school: '', status: '', occupation: '' }),
  ...
  const handleAddStudent = () => {
    ...
    const studentToAdd = {
      ...newStudent,
      id,
      birthDate: `${newStudent.birthMonth} ${newStudent.birthDay}, ${newStudent.birthYear}`
    };
  ...
  const handleSacramentChange = (sacrament, field, value) => {
    setNewStudent(prev => ({
      ...
      [sacrament]: {
        ...prev[sacrament],
        [field]: field === 'received' ? !prev[sacrament].received : value
      }
    }));
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white rounded-xl shadow-lg overflow-hidden p-6 mb-8 border border-gray-100">
        ...
        <p className="text-gray-600 mb-6">St. Rita's College of Balingasag - Basic Education Department</p>
...
{showModal && (
  <StudentModal
    ...
    initialStudentState={initialStudentState} // Add this prop
  />
)}
...
{printingStudent && (
  <div className="hidden print:block">
    <BasicEdPrintView student={printingStudent} />
  </div>
)}
    </div>
  );
